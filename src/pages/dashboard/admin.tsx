...
export default function Dashboard() {
  ...
  return (
    <>
      <Head>
        <title>Admin | ATK Inventory</title>
                ...
                <div className="p-5">
                  <div className="flex items-center">
                    <div className="flex-shrink-0">
                      <div className={`p-3 rounded-md ${index === 0 ? 'bg-blue-500' :
                          index === 1 ? 'bg-green-500' :
                            index === 2 ? 'bg-yellow-500' :
                              'bg-purple-500'
                        } bg-opacity-10`}>
                        <svg
                          className={`h-6 w-6 ${index === 0 ? 'text-blue-500' :
                    ...
                    <div className="ml-5 w-0 flex-1">
                      <dl>
                        ...
                        <dd className="flex items-baseline">
                          ...
                          <div className={`ml-2 flex items-baseline text-sm font-semibold ${stat.trendDir === 'up' ? 'text-green-600' : 'text-red-600'
                            }`}>
                            {stat.trendDir === 'up' ? (
                    ...
                    <li key={activity.id}>
                      <div className="relative pb-8">
                        ...
                        <div className="relative flex space-x-3">
                          <div>
                            <span
                              className={`${activity.status === 'success' ? 'bg-green-400' : 'bg-blue-400'
            ...
            {[
              ...
              >
                <div className="flex items-center justify-between mb-4">
                  ...
                  <span className={`px-2.5 py-0.5 rounded-full text-sm font-medium ${card.change.startsWith('+') ? 'bg-green-100 text-green-800' : 'bg-red-100 text-red-800'
                    }`}>
                    {card.change}
                  </span>
                </div>
